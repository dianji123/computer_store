package com.hzh.computer_store.vo;
...
public class CartVO implements Serializable {
    ...
    /**
     * VO全称Value Object,值对象。当进行select查询时,查询的结果属于多张表中的内容,
     * 此时发现结果集不能直接使用某个POJO实体类来接收,因为POJO实体类不能包含多表查询出来的信息,
     * 值对象用于存储所查询出来的结果集对应的映射
     */
    private Integer cid;
    private Integer uid;
    private Integer pid;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CartVO)) return false;

        CartVO cartVO = (CartVO) object;
